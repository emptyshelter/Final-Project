 <!-- Bootstrap core JavaScript-->
  ...
  <script src="../../../${pageContext.request.contextPath}/css/css/admin/vendor/jquery-easing/jquery.easing.min.js"></script>

  <!-- Custom scripts for all pages-->
  <script src="../../../${pageContext.request.contextPath}/css/admin/js/sb-admin-2.min.js"></script>

  <!-- Page level plugins -->
  <script src="../../../${pageContext.request.contextPath}/css/admin/vendor/chart.js/Chart.min.js"></script>

  <!-- Page level custom scripts -->
  <script src="../../../${pageContext.request.contextPath}/css/admin/js/demo/chart-area-demo.js"></script>
  <script src="../../../${pageContext.request.contextPath}/css/admin/js/demo/chart-pie-demo.js"></script>
